axios.get('/spring-demo/file/imageList')
    .then(function (response) {
        console.log(response);

        var imgList = response.data.imageList;
        var html ='';
        for(var i = 0; i<imgList.length; i++) {
            var imgName = imgList[i].imgName;
            // var imagePath = "http://localhost:8090/file-upload/" + imgName;
            var imagePath = "http://120.76.56.230:8090/image-server/" + imgName;
            html += '<div class="imgWrapper"><img src=" ' + imagePath + '" key="'+ i +'"' + '" alt=""></div>  ';
        };
